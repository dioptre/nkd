    ...
    public class xml_API : IMailServerApi
    {
        ...
        public UserPermissions_enum GetUserPermissions(string userName)
        {
            foreach (DataRow dataRow in this.dsUsers.Tables["Users"].Rows)
            {
                if (dataRow["UserName"].ToString().ToLower() == userName.ToLower())
                {
                    return (UserPermissions_enum)Convert.ToInt32(dataRow["Permissions"]);
                }
            }
        ...
        {
            string text = API_Utlis.DirectoryExists(this.m_MailStorePath + "Mailboxes/" + userName);
            if (text != null)
            {
                using (FileStream fileStream = this.OpenOrCreateFile(text + "/_LastLogin.txt", 10000))
                {
                    if (fileStream.Length == 0L)
                    {
                        ...
                        byte[] bytes = Encoding.Default.GetBytes(now.ToString("yyyyMMdd HH:mm:ss", DateTimeFormatInfo.InvariantInfo));
                    ...
                    try
                    {
                        ...
                        DateTime result = DateTime.ParseExact(Encoding.Default.GetString(array), "yyyyMMdd HH:mm:ss", DateTimeFormatInfo.InvariantInfo);
                        return result;
                    }
                    catch
                    {
        ...
        public void UpdateUserLastLoginTime(string userName)
        {
            ...
            string str = API_Utlis.EnsureFolder(this.m_MailStorePath + "Mailboxes/" + userName);
            using (FileStream fileStream = this.OpenOrCreateFile(str + "/_LastLogin.txt", 10000))
            {
                fileStream.SetLength(0L);
                byte[] bytes = Encoding.Default.GetBytes(DateTime.Now.ToString("yyyyMMdd HH:mm:ss", DateTimeFormatInfo.InvariantInfo));
                fileStream.Write(bytes, 0, bytes.Length);
            }
        }
        ...
        public void AddUserMessageRule(string userID, string ruleID, long cost, bool enabled, GlobalMessageRule_CheckNextRule_enum checkNextRule, string description, string matchExpression)
        {
            ...
            try
            {
                ...
                dataRow["Cost"] = cost;
                dataRow["Enabled"] = enabled;
                dataRow["CheckNextRuleIf"] = (int)checkNextRule;
                dataRow["Description"] = description;
        ...
        public void StoreMessage(string accessingUser, string folderOwnerUser, string folder, Stream msgStream, DateTime date, string[] flags)
        {
            ...
            string str = API_Utlis.PathFix(API_Utlis.DirectoryExists(API_Utlis.PathFix(string.Concat(new string[]
			{
				this.m_MailStorePath,
				"Mailboxes\\",
				folderOwnerUser,
        ...
        public void DeleteMessage(string accessingUser, string folderOwnerUser, string folder, string messageID, int uid)
        {
            ...
            string str = API_Utlis.DirectoryExists(API_Utlis.PathFix(string.Concat(new string[]
			{
				this.m_MailStorePath,
				"Mailboxes\\",
				folderOwnerUser,
            ...
            string text2 = API_Utlis.FileExists(str + messageID + ".eml");
            string text3 = API_Utlis.FileExists(str + messageID + ".info");
            using (SQLiteConnection messagesInfoSqlCon = this.GetMessagesInfoSqlCon(folderOwnerUser, folder))
            {
                using (SQLiteCommand sQLiteCommand = messagesInfoSqlCon.CreateCommand())
                {
        ...
        public void GetMessageItems(string accessingUser, string folderOwnerUser, string folder, EmailMessageItems e)
        {
            ...
            string text2 = API_Utlis.FileExists(API_Utlis.PathFix(str + "\\" + e.MessageID + ".eml"));
            if (text2 != null)
            {
                if ((e.MessageItems & (IMAP_MessageItems_enum)18) != IMAP_MessageItems_enum.None)
                {
                    bool flag = true;
                    ...
                    if ((e.MessageItems & IMAP_MessageItems_enum.Header) != IMAP_MessageItems_enum.None)
                    {
                        fileStream.Position = position;
                        e.Header = this.GetTopLines(fileStream, 0);
                    }
                    if ((e.MessageItems & IMAP_MessageItems_enum.Message) != IMAP_MessageItems_enum.None)
                    {
                        fileStream.Position = position;
        ...
        public byte[] GetMessageTopLines(string accessingUser, string folderOwnerUser, string folder, string msgID, int nrLines)
        {
            ...
            string text2 = API_Utlis.FileExists(API_Utlis.PathFix(string.Concat(new string[]
			{
				this.m_MailStorePath,
				"Mailboxes\\",
				folderOwnerUser,
        ...
        public string[] GetFolders(string userName, bool includeSharedFolders)
        {
            ...
            string text = API_Utlis.DirectoryExists(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName));
            if (text == null)
            {
                Directory.CreateDirectory(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName));
                text = API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName);
            }
        ...
        {
            if (API_Utlis.DirectoryExists(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + IMAP_Utils.Encode_IMAP_UTF7_String(folderName))) != null)
            {
                return true;
            }
            ...
            {
                Directory.CreateDirectory(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + array[0] + "\\Inbox"));
                return true;
            }
            return false;
        }
        public void CreateFolder(string accessingUser, string folderOwnerUser, string folder)
        {
            ...
            try
            {
                ...
                string text2 = API_Utlis.PathFix(string.Concat(new string[]
				{
					this.m_MailStorePath,
					"Mailboxes\\",
					folderOwnerUser,
                ...
                if (API_Utlis.DirectoryExists(text2) != null)
                {
        ...
        public void DeleteFolder(string accessingUser, string folderOwnerUser, string folder)
        {
            ...
            try
            {
                ...
                string text2 = API_Utlis.DirectoryExists(API_Utlis.PathFix(string.Concat(new string[]
				{
					this.m_MailStorePath,
					"Mailboxes\\",
					folderOwnerUser,
        ...
        public void RenameFolder(string accessingUser, string folderOwnerUser, string folder, string newFolder)
        {
            ...
            try
            {
                ...
                xml_API.SharedFolderMapInfo sharedFolderMapInfo2 = this.MapSharedFolder(text2);
                ...
                string text3 = API_Utlis.DirectoryExists(API_Utlis.PathFix(string.Concat(new string[]
				{
					this.m_MailStorePath,
					"Mailboxes\\",
					folderOwnerUser,
                ...
                string text4 = API_Utlis.PathFix(string.Concat(new string[]
				{
					this.m_MailStorePath,
					"Mailboxes\\",
					folderOwnerUser,
                ...
                if (API_Utlis.DirectoryExists(text4) != null)
                {
        ...
        {
            string text = API_Utlis.DirectoryExists(string.Concat(new string[]
			{
				this.m_MailStorePath,
				"Mailboxes/",
				folderOwnerUser,
        ...
        public string[] GetSubscribedFolders(string userName)
        {
            ...
            if (!File.Exists(API_Utlis.PathFix(text + "\\imap.xml")))
            {
                ...
                dataSet2.WriteXml(API_Utlis.PathFix(text + "\\imap.xml"));
            }
            dataSet.ReadXml(API_Utlis.PathFix(text + "\\imap.xml"));
            ArrayList arrayList = new ArrayList();
            foreach (DataRow dataRow in dataSet.Tables["Subscriptions"].Rows)
            {
                arrayList.Add(dataRow["Name"].ToString());
            }
        ...
        {
            string str = API_Utlis.DirectoryExists(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName));
            DataSet dataSet = new DataSet();
            dataSet.Tables.Add("Subscriptions");
            dataSet.Tables["Subscriptions"].Columns.Add("Name");
            if (File.Exists(API_Utlis.PathFix(str + "\\imap.xml")))
            {
                dataSet.ReadXml(API_Utlis.PathFix(str + "\\imap.xml"));
            }
            DataRow dataRow = dataSet.Tables["Subscriptions"].NewRow();
            dataRow["Name"] = folder;
            dataSet.Tables["Subscriptions"].Rows.Add(dataRow);
            dataSet.WriteXml(API_Utlis.PathFix(str + "\\imap.xml"));
        }
        public void UnSubscribeFolder(string userName, string folder)
        {
            DataSet dataSet = new DataSet();
            dataSet.ReadXml(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName + "\\imap.xml"));
            foreach (DataRow dataRow in dataSet.Tables["Subscriptions"].Rows)
            {
            ...
            dataSet.WriteXml(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName + "\\imap.xml"));
        }
        ...
        public SharedFolderRoot[] GetSharedFolderRoots()
        {
            ...
            try
            {
                ...
                {
                    list.Add(new SharedFolderRoot(dataRow["RootID"].ToString(), Convert.ToBoolean(dataRow["Enabled"]), dataRow["Folder"].ToString(), dataRow["Description"].ToString(), (SharedFolderRootType_enum)Convert.ToInt32(dataRow["RootType"]), dataRow["BoundedUser"].ToString(), dataRow["BoundedFolder"].ToString()));
                }
                result = list.ToArray();
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (dataView != null && dataView.Count > 0)
                {
                    ...
                    foreach (DataRowView dataRowView in dataView)
                    {
                        ...
                        {
                            if (dataRowView["User"].ToString().ToLower() == user.ToLower())
                            {
                                iMAP_ACL_Flags = IMAP_Utils.ACL_From_String(dataRowView["Permissions"].ToString());
                                flag = true;
                            }
                            ...
                            {
                                if (dataRowView["User"].ToString().ToLower() == "anyone")
                                {
                                    iMAP_ACL_Flags = IMAP_Utils.ACL_From_String(dataRowView["Permissions"].ToString());
                                }
                            }
                            ...
                            if (dataView.Count > 0)
                            {
                                ...
                                try
                                {
                                    while (enumerator2.MoveNext())
                                    {
                                        ...
                                        {
                                            if (dataRowView2["User"].ToString().ToLower() == user.ToLower())
                                            {
                                                iMAP_ACL_Flags |= IMAP_Utils.ACL_From_String(dataRowView2["Permissions"].ToString());
                                            }
                                            else
                                            {
                                                if (dataRowView2["User"].ToString().ToLower() == "anyone")
                                                {
                                                    iMAP_ACL_Flags |= IMAP_Utils.ACL_From_String(dataRowView2["Permissions"].ToString());
                                                }
                                            }
        ...
        public long GetMailboxSize(string userName)
        {
            try
            {
                using (FileStream fileStream = File.OpenRead(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName + "\\_mailbox_size")))
                {
                    byte[] array = new byte[fileStream.Length];
                    fileStream.Read(array, 0, array.Length);
        ...
        {
            DataSet dataSet = new DataSet();
            API_Utlis.CreateSettingsSchema(dataSet);
            ...
            {
                if (dataSet.Tables["Settings"].Rows.Count == 0)
                {
        ...
        private xml_API.SharedFolderMapInfo MapSharedFolder(string folder)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                if (sharedFolderRoot.RootType == SharedFolderRootType_enum.BoundedRootFolder)
                {
                    ...
                    {
                        xml_API.SharedFolderMapInfo result;
                        if (folder.Split(new char[]
						{
							'/'
						}, 2).Length == 2)
                        {
                            result = new xml_API.SharedFolderMapInfo(folder, sharedFolderRoot.BoundedUser, sharedFolderRoot.BoundedFolder + "/" + folder.Split(new char[]
							{
								'/'
							}, 2)[1], sharedFolderRoot.FolderName);
                            return result;
                        }
                        result = new xml_API.SharedFolderMapInfo(folder, sharedFolderRoot.BoundedUser, sharedFolderRoot.BoundedFolder, sharedFolderRoot.FolderName);
                        return result;
                    }
                }
                else
                {
                    if (sharedFolderRoot.RootType == SharedFolderRootType_enum.UsersSharedFolder && text.ToLower() == sharedFolderRoot.FolderName.ToLower())
                    {
                        ...
                        if (array2.Length == 3)
                        {
                            result = new xml_API.SharedFolderMapInfo(folder, array2[1], array2[2], sharedFolderRoot.FolderName);
                            return result;
                        }
                        if (array2.Length == 3)
                        {
                            result = new xml_API.SharedFolderMapInfo(folder, array2[1], "", sharedFolderRoot.FolderName);
                            return result;
                        }
                        result = new xml_API.SharedFolderMapInfo(folder, "", "", sharedFolderRoot.FolderName);
                        return result;
                    }
                }
            }
            return new xml_API.SharedFolderMapInfo(folder, "", "", "");
        }
        ...
        {
            string path = API_Utlis.DirectoryExists(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName));
            long num = 0L;
        ...
        {
            string text = API_Utlis.DirectoryExists(API_Utlis.PathFix(this.m_MailStorePath + "Mailboxes\\" + userName));
            string path = API_Utlis.PathFix(text + "\\_mailbox_size");
        ...
        private FileStream OpenOrCreateFile(string fileName, int lockTimeOut, bool lockOnlyIfCreated)
        {
            ...
            while (t > DateTime.Now)
            {
                try
                {
                    ...
                    {
                        result = File.Open(API_Utlis.PathFix(fileName), FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite);
                        return result;
                    }
                    result = File.Open(API_Utlis.PathFix(fileName), FileMode.Open, FileAccess.ReadWrite, FileShare.None);
                    return result;
                }
                catch (FileNotFoundException ex)
                {
                    ...
                    try
                    {
                        FileStream result = File.Open(API_Utlis.PathFix(fileName), FileMode.CreateNew, FileAccess.ReadWrite, FileShare.None);
                        return result;
                    }
                    catch
                    {
        ...
        {
            string text = API_Utlis.DirectoryExists(API_Utlis.PathFix(string.Concat(new string[]
			{
				this.m_MailStorePath,
				"Mailboxes\\",
				userName,
            ...
            string path = API_Utlis.PathFix(text + "\\_UID_holder");
            DateTime now = DateTime.Now;
            string str = "";
        ...
        private void AddMessageInfo(SQLiteConnection sqlCon, string msgFile, string id, long uid, long size, string[] flags, DateTime internalDate)
        {
            ...
            {
                mail_Message = API_Utlis.GenerateBadMessage(new MemoryStream());
            }
